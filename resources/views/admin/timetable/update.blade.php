...
@section('content')
    <div class="layui-elem-quote">更新课表</div>
    <form class="layui-form" action="{{route('timetable.update',['role'=>$timetable])}}" method="post">
        {{csrf_field()}}
        {{method_field('put')}}
...
{{--        </div>--}}
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="number" value="{{$timetable->number}}"  lay-verify="required" placeholder="请输入编号" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label for="" class="layui-form-label">用户名</label>
            <div class="layui-input-inline">
                <input type="text" name="username" value="{{ $timetable->name }}" lay-verify="required" placeholder="请输入用户名" class="layui-input" >
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="age" value="{{$timetable->age}}"  lay-verify="required" placeholder="请输入年龄" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title" value="{{ $timetable->class }}" lay-verify="required" placeholder="请输入班级" class="layui-input" >
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <a class="layui-btn" href="{{route('timetable.index')}}" >返 回</a>
            </div>
        </div>
    </form>
@endsection
